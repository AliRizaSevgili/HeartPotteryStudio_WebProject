...
function saveTokenToStorage(token) {
    localStorage.setItem('homepageRecaptchaToken', token);
}

function getTokenFromStorage() {
    return localStorage.getItem('homepageRecaptchaToken');
}

// DOM yüklendikten sonra
document.addEventListener("DOMContentLoaded", function () {
    // Form ve token input'unu seç
    const form = document.querySelector("form[action='/contact']");  // Homepage formunun action'ı
    ...
    if (form) {
        form.addEventListener("submit", function(e) {
            ...
            // Toggle kontrolü (eğer homepage'de privacy policy toggle varsa)
